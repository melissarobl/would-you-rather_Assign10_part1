...
const wyrQuestion = ref('Would you rather be able to read minds or see one day into the future?')
const wyrAnswer1 = ref('Read Minds')
const wyrAnswer2 = ref('See One Day into Future')
